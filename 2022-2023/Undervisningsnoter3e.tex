...
\begin{align*}
	s = \sqrt{\frac{\sum_{i=1}^n\left(\hat{x_i - \hat{\mu}}\right)}{n-1}}.
\end{align*}
\end{defn}
...
\begin{exa}
Vi har følgende \href{data}{link}, og vi ønsker at bestemme middelværdien og spredningen for datasættet. Dette gøres i Maple ved at skrive
\begin{align*}
	&\texttt{with(Gym):}
	&\texttt{middel(Data)}
...
\section*{Opgave 1}
\href{Dette data}{link} beskriver IQ for 213 værnepligtige. 
...
\section*{Opgave 2}
173 raske personer har fået målt deres temperatur. Resultatet er i \href{dette datasæt}{link}.
\begin{enumerate}[label=\roman*)]
...
\section*{Opgave 3}
501 kvinder har målt deres højde. Resultatet kan findes \href{her}{link}.
\begin{enumerate}
