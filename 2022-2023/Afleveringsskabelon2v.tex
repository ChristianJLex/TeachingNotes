...
\begin{opgavetekst}{Opgave 8}
	I \href{hyperlink}{\color{blue!50} dette datasæt} er sammenhængen mellem forløbet tid (i timer) og antallet af 		    bakterier (i mia.) i en opløsning givet. Det antages at antallet af bakterier $B$ (i mia) kan beskrives ved en 
	model af typen
	\begin{align*}
		B(t) = b\cdot a^t,
	\end{align*}
