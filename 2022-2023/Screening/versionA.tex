...
\end{delopgave}
\begin{delopgave}{(5 point)}{1}
	Bestem andenkoordinaten $y$ i punktet $P(2,y)$ på Fig. \ref{fig:lines}.
\end{delopgave}
...
\begin{opgavetekst}{Opgave 4}
	På Fig. \ref{fig:oneline} ses grafen for en lineær funktion $f$ givet ved
	\begin{align*}
		f(x) = ax + b.
	\end{align*}
	\begin{figure}[H]
...
\end{opgavetekst}
\begin{delopgave}{(10 point)}{1}
	Brug Fig. \ref{fig:oneline} til at bestemme $a$ og $b$. 
\end{delopgave}
\begin{delopgave}{(5 point)}{2}
...
\begin{opgavetekst}{Opgave 5}
	...
	\end{center}
	En gruppe venner skovler sand til et byggeprojekt. Mængden af sand de kan skovle som funktion af antallet af personer kan ses af Tab. \ref{tab:sand}.
...
\end{opgavetekst}
\begin{delopgave}{(10 point)}{1}
	Brug tallene fra Tab. \ref{tab:sand} til at bestemme $a$ og $b$. 
\end{delopgave}
\begin{delopgave}{(10 point)}{2}
	Hvor meget sand kan 7 personer skovle i timen ifølge modellen?
\end{delopgave}
...
\begin{opgavetekst}{Opgave 6}
	På Fig. \ref{fig:twolines} ses graferne for funktionerne $f$ og $g$ givet ved henholdsvist 
	\begin{align*}
		f(x) &= -x+5,\\
		g(x) &= 2x-1.	
	\end{align*}	 
...
\end{opgavetekst}
\begin{delopgave}{(10 point)}{1}
	Bestem koordinaterne til skæringspunktet $P$ mellem graferne på Fig. \ref{fig:twolines}.
\end{delopgave}