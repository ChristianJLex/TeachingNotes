	...
	\begin{figure}[H]
		...
		\begin{tikzpicture}
			\begin{axis}[
				...
				\addplot[samples = 10, color = blue!40, thick] {3*x+7};
				\addplot[samples = 10, color = red!40, thick]	{-5*x-9};
				\node[circle, fill = purple, inner sep = 0pt, minimum size = 5pt] at 
				(axis cs: -2,1) {};
				\node at (axis cs:-2,4) {$P$};
				\node at (axis cs: 4,-26) {$\color{red!60} g$};
				\node at (axis cs: 4,16) {$\color{blue!60} f$};
			\end{axis}
			\node at (9,4.3) {(1)};
			\node at (4.25,7.5) {(2)};
		\end{tikzpicture}
	...
	\begin{figure}[H]
		...
		\begin{tikzpicture}
			\begin{axis}[
				...
				\node at (axis cs:1.7,-2) {$P(1,-1)$};
				\node at (axis cs:3.7,2) {$Q(3,1)$};
...
\end{delopgave}
\begin{delopgave}{(5 point)}{2}
	Bestem andenkoordinaten $y$ i punktet $P(1,y)$.
\end{delopgave}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
