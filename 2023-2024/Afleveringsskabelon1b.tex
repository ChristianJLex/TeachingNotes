...
\begin{opgavetekst}{Opgave 1}
	\begin{center}
		\includegraphics[width = 0.5\textwidth]{Billeder/Zoo1}
	\end{center}
	En zoologisk have har hvert år siden år 1980 målt antallet af besøgende. Deres målinger 
	fremgår af \href{https://github.com/ChristianJLex/TeachingNotes/raw/master/2023-2024/Data og lign/ZooBesoegende.xlsx}{\color{blue!60} dette datasæt}.
	Den zoologiske have har en forventning om, at antallet af besøgende $f$ kan beskrives
	ved forskriften
	\begin{align*}
		f(x) = b\cdot x^a,
	\end{align*}
...
\begin{delopgave}{}{1}
	Brug tallene fra datasættet til at bestemme en forskrift for $f$. 
\end{delopgave}
\begin{delopgave}{}{2}
	Beste
\end{delopgave}
