...
\subsection*{Opgave 1}
Udregn følgende produkter af brøker.

\begin{align*}
	 & a) \  4\cdot \frac{5}{20} & &b) \ -3\cdot \frac{11}{66} & &c) \  9 \cdot \frac{4}{18}   
	 \\	 
	 &d) \ \frac{12}{2}\cdot \frac{2}{6} & &e) \ \frac{4}{5}\cdot \frac{10}{2}  &   &f) \ \frac{7}{9} \cdot \frac{9}{7}
\end{align*}

\subsection*{Opgave 2}
Udregn følgende summer af brøker.

\begin{align*}
	 & a) \  \frac{2}{3} + \frac{2}{6} & &b) \ \frac{-1}{2} + \frac{10}{4} & &c) \  \frac{4}{5} + 1
\end{align*}

\subsection*{Opgave 3}
Udregn følgende divisioner af brøker.

\begin{align*}
	 & a) \  \frac{\frac{1}{4}}{\frac{4}{1}} & &b) \ \frac{\frac{4}{7}}{\frac{2}{3}} & &c) \  \frac{\frac{5}{3}}{\frac{2}{-4}} 
\end{align*}

\newpage
\subsection*{Opgave 4}
Udregn følgende brøker og forkort så meget som muligt. Tjek dit resultat i Maple.
...
\subsection*{Opgave 7}
Udregn følgende brøker. 
\begin{align*}
		&a)\ \sqrt{\frac{\frac{100}{36}}{\frac{25}{49}}} && b) \   \left(\frac{\sqrt{\frac{5}{7}}}{\sqrt{\frac{2}{9}}}\right)^2 + \sqrt[3]{\frac{\left(\frac{2+5}{3+11}\right)^3}{\left( \frac{5}{7-6}\right)^3}}
\end{align*}