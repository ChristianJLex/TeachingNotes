...
Normalfordeling
\end{center}
\section*{Kontinuert stokastisk variabel}
\stepcounter{section}

Både den Bernoulli-fordelte stokastiske variabel og den binomialfordelte stokastiske variabel er \textit{diskrete} stokastiske variable, da de kun kan antage et endeligt antal værdier. Den Bernoulli-fordelte stokastiske variabel kan antage to: $0$ og 1. Og den binomialfordelte stokastiske variabel $X \sim \textnormal{Bin}(n,p)$ kan antage $n$, hvor $n$ er antalsparametren for $X$. Der findes også kontinuerte stokastiske variable, hvor den eneste vi skal stifte bekendtskab med er den normalfordelte stokastiske variabel. Sådanne stokastiske variable kan antage værdier på et interval $I = [a,b]\subseteq \mathbb{R}$, og sandsynlighederne for udfald vil så være givet ved sandsynligheden for at ligge inden for et delinterval $[\alpha,\beta]\subseteq [a,b]$. 
