...
(f(x)g(x))' &= \lim_{h\to 0}\frac{f(x+h)g(x+h)-f(x)g(x)}{h}\\
            ...
            &= f'(x)g(x)+g'(x)f(x).
\end{align*}
Bemærk, at vi har anvendt, at 
\begin{align*}
\lim_{x\to a}(h_1(x)h_2(x)) = \lim_{x\to a}(h_1(x))\lim_{x\to a}(h_2(x)),
\end{align*}
og
\begin{align*}
\lim_{x\to a}(h_1(x)+h_2(x)) = \lim_{x\to a}(h_1(x))+\lim_{x\to a}(h_2(x)),
\end{align*}
for funktioner $h_1,h_2$ og punkt $a$. Vi anvender også, at $g$ er differentiabel i $x$ og dermed også kontinuert i $x$.  
\end{proof}
\section*{Optimering}
\stepcounter{section}
