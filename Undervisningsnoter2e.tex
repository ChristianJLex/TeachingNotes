...
\begin{exa}
Vi betragter cirklen på Fig. \ref{fig:cirkel2}. Vi skal bestemme de tangenter til cirklen, der har hældning -1. Dette gøres i Geogebra (\href{yada}{\color{blue!60} Link til fil}), og tangenterne findes til at have ligningerne 
\begin{align*}
y = -x+5 
\end{align*}
og
